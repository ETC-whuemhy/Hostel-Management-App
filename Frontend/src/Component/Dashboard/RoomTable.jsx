                ...
                <tbody className='table__body'>
                    {rooms.map((room, index) => (
                            <tr key={index} className='table__row'>
                                ...
                                <td className='same_class'><FaPen size={20} color='blue' onClick={() => handleEditClick(room)} className='_noBg'/>
                                  &nbsp; &nbsp; <RiDeleteBin6Line size={20} color='red' onClick={() => onDeleteRoom(room._id)} className='_noBg'/>
                                </td>
                            </tr>
                        ))
                    }
